...
function download {
	...
	local url="https://github.com/ibmruntimes/semeru26-certified-binaries/releases/download/${tag_name}/${asset_name}"
...
RELEASE_FILE="${TEMP_DIR}/releases-${VENDOR}-26.json"
download_github_releases 'ibmruntimes' 'semeru26-certified-binaries' "${RELEASE_FILE}"

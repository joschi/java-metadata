...
function download {
	...
	local url="https://github.com/ibmruntimes/semeru26-binaries/releases/download/${tag_name}/${asset_name}"
...
download_github_releases 'ibmruntimes' 'semeru26-binaries' "${RELEASE_FILE}"

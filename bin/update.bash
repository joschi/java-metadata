...
for vendor in 'adoptopenjdk' 'corretto' 'graalvm-legacy' 'graalvm' 'zulu' 'sapmachine' 'liberica' 'dragonwell8' 'dragonwell11' 'openjdk' 'java-se-ri' 'mandrel' 'trava8' 'trava11'
do
